...
<br></br>
    ...
    <h4 className="italic text-black sm:text-black-100 text-4xl font-medium md:col-auto mx-1 my-1 hover:opacity-55"> 📁Projects\ 💼Work </h4> <br></br>
...
1. Structuring large-scale HTML/CSS & JavaScript project. <br></br>

2. Creating reusable components in pure JavaScript.<br></br>

3. Designing for mobile-first and responsive behavior.<br></br>
...
Demonstrates proficiency in API integration, asynchronous JavaScript, and responsive UI design. <br></br> <br></br>
 <p className="text-violet-600 text-2xl italic">What I Learned: </p>
1. Working with external REST APIs. <br></br>
...
<br></br>
<br></br>
<h4 className="italic sm:text-black-100 text-4xl font-medium md:col-auto mx-1 my-1 hover:opacity-50">🎓Internships\🧑‍💼Certifications </h4> <br></br>
